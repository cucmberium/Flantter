...
namespace Flantter.MilkyWay.Models.Apis.Objects
{
    public class Entities
    {
        ...
        public Entities(IEnumerable<TootNet.Objects.Attachment> cAttachments,
            IEnumerable<TootNet.Objects.Mention> cMentions, IEnumerable<TootNet.Objects.Tag> cTags,
    ...
    public class HashtagEntity
    {
        ...
        public HashtagEntity(TootNet.Objects.Tag cHashTag)
        {
            Tag = cHashTag.Name;
            Start = 0;
            End = 0;
    ...
    public class UserMentionEntity
    {
        ...
        public UserMentionEntity(TootNet.Objects.Mention cMention)
        {
            Id = cMention.Id;
            Name = cMention.UserName;
            ScreenName = cMention.Acct;
            Start = 0;
            End = 0;
        }
