...
namespace Flantter.MilkyWay.Models.Apis
{
    ...
    public static class TweetRegexPatterns
    {
        ...
        private static readonly string UrlValidGtld =
            "(?:(?:" + string.Join("|", TldList.GtldList) + ")(?=[^" + AlnumChars + "@]|$))";

        private static readonly string UrlValidCctld =
            "(?:(?:" + string.Join("|", TldList.CtldList) + ")(?=[^" + AlnumChars + "@]|$))";
        ...
        private const string UrlValidSubdomain =
            "(?>(?:[" + UrlValidChars + "][" + UrlValidChars + "\\-_]*)?[" + UrlValidChars + "]\\.)";

        private const string UrlValidDomainName =
            "(?:(?:[" + UrlValidChars + "][" + UrlValidChars + "\\-]*)?[" + UrlValidChars + "]\\.)";
        ...
        private const string UrlValidGeneralPathChars =
            "[a-z\\p{IsCyrillic}0-9!\\*';:=\\+,.\\$/%#\\[\\]\\-_~\\|&@" + LatinAccentsChars + "]";
        ...
        private const string UrlValidPathEndingChars =
            "[a-z\\p{IsCyrillic}0-9=_#/\\-\\+" + LatinAccentsChars + "]|(?:" + UrlBalancedParens + ")";
        ...
        public static readonly Regex ValidMastodonMentionOrList =
            new Regex(
                "([^a-z0-9_!#$%&*" + AtSignsChars + "]|^|(?:^|[^a-z0-9_+~.-])RT:?)(" + AtSigns +
                "+)([a-z0-9_]{1,20})(/[a-z][a-z0-9_\\-]{0,24})?(@[a-z][a-z0-9\\-\\.]*)?",
